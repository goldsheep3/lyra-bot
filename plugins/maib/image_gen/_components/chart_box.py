...
from ..style import get_difficulty_style, DIFFICULTY_TYPE, DifficultyStyle, get_note_designer_text
...
class ChartBoxBadge:
    ...
    def _base(cls, difficulty: DIFFICULTY_TYPE, cabinet: Literal['SD', 'DX'],
        ...
        drawer.rounded_rect(0, ow+2, width, 5, fill=style.title_bg, closed_interval=False)
    ...
    def _box(cls, chart: MaiChart, cabinet: Literal['SD', 'DX'], server: Server, plus: bool,
        ...
        Drawer(final_img, ms=ms).rounded_rect(ow, ow, weight-ow, height-ow, radius=4, fill=None,
                                              outline=difficulty_style.frame, width=1, closed_interval=False)
