...
from ..style import DIFFICULTY_TYPE, get_difficulty_style
...
class LevelBadge:
    ...
    def _level_badge(cls, integer: str, fractional: str, difficulty: DIFFICULTY_TYPE,
    ...
    @classmethod
    def _level(cls, level: float, difficulty: DIFFICULTY_TYPE,
    ...
    @classmethod
    def level(cls, level: float, difficulty: DIFFICULTY_TYPE,
              display_plus_mask: bool = False, display_frac: _LEVEL_DECIMAL_TYPE = 'display',
